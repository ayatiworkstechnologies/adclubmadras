    ...
    if (user?.id) {
      getUserDetails({ user_id: user.id })
        .then(async (res) => {
          ...
          // 🔄 Fetch membership details using email
          if (data?.email) {
    ...
    <div className="min-h-screen bg-black text-white p-6 mt-20 font-glancyr">
      <div className="max-w-6xl mx-auto bg-black/80 rounded-2xl shadow-lg p-4 md:p-8 flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-3/4">
          <div className="bg-gray-900 rounded-xl p-6 min-h-[500px] flex flex-col justify-between">
            {tab === "profile" && (
              <motion.div
                  ...
                  <>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      >
                        ...
                        {/* <button className="mt-4 px-6 py-2 bg-sky-700 hover:bg-sky-800 text-white rounded transition">
                          Renew Membership
                        </button> */}
                      </motion.div>
                      ...
                      >
                        ...
                        <div className="bg-gray-800 p-4 rounded space-y-2 border border-gray-700">
                          ...
                          <p className="text-sm flex items-center gap-2 text-gray-300">
                            <FaPhoneAlt /> {userData.membershipDetails.phone}
                          </p>
                          <p className="text-sm flex items-center gap-2 text-gray-300">
                          ...
                          <div className="mt-3">
                            ...
                            <div className="flex items-center gap-4 mt-2 text-sky-400 text-xl">
                              {userData.membershipDetails.facebook && (
                                <a
                                  href={`https://facebook.com/${userData.membershipDetails.facebook}`}
                                  target="_blank"
                                  rel="noreferrer"
                                >
                                  <FaFacebookF />
                              ...
                              {userData.membershipDetails.twitter && (
                                <a
                                  href={`https://twitter.com/${userData.membershipDetails.twitter}`}
                                  target="_blank"
                                  rel="noreferrer"
                                >
                                  <FaXTwitter />
                              ...
                              {userData.membershipDetails.linkedin && (
                                <a
                                  href={`https://linkedin.com/in/${userData.membershipDetails.linkedin}`}
                                  target="_blank"
                                  rel="noreferrer"
                                >
                                  <FaLinkedinIn />
                    ...
                    {/* Corporate Members Section - New Row Below */}
                      ...
                      userData.membershipDetails.members && (
                        <div className="mt-8">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            {JSON.parse(userData.membershipDetails.members)
                              .filter((m) => m.name)
                              .map((member, idx) => (
                                <motion.div
                                  key={idx}
                                  whileHover={{ scale: 1.02 }}
                                  className="bg-gray-800 text-white p-4 rounded shadow border border-gray-700"
                                >
